...
ALL_CHIPS="esp32 esp32s2 esp32s3 esp32c2 esp32c3 esp32c5 esp32c6 esp32c61 esp32h2 esp32p4 esp32s31 "
...
build latest components/driver/test_apps/twai "$(chips_without esp32c2 esp32c61 esp32s31)"
build latest components/efuse/test_apps "$(chips_without esp32s31)"
...
build latest components/esp_driver_i2c/test_apps/i2c_test_apps "$(chips_without esp32s31)"
build latest components/esp_driver_i2s/test_apps/i2s "$(chips_without esp32c2 esp32s31)"
build latest components/esp_driver_ledc/test_apps/ledc "$(chips_without esp32s31)"
build latest components/esp_driver_pcnt/test_apps/pulse_cnt "esp32 esp32s2 esp32s3 esp32c5 esp32c6 esp32h2 esp32p4"
build latest components/esp_driver_spi/test_apps/master "$(chips_without esp32s31)"
...
# Path changed from components/esp_hw_support/test_apps/dma in IDF 6.0
build latest components/esp_driver_dma/test_apps/dma "$(chips_without esp32)"
...
build latest components/esp_wifi/test_apps/wifi_function "esp32 esp32s2 esp32s3 esp32c2 esp32c3 esp32c5 esp32c6 esp32c61 esp32s31"
...
build latest examples/peripherals/adc/oneshot_read "$(chips_without esp32s31)"
build latest examples/peripherals/i2c/i2c_simple "$(chips_without esp32s31)"
build latest examples/peripherals/ledc/ledc_basic "$(chips_without esp32s31)"
build latest examples/peripherals/rmt/led_strip "$(chips_without esp32c61 esp32s31)"
build latest examples/peripherals/spi_slave/sender "$(chips_without esp32s31)"
